...
import type { range, rangeMapEntries, transition, transform, boxShadow, convertBoxShadow, border, rgb, rgba, important, lerpcss, hsl, lightDark, calc, url, format, hslFrom, rgbFrom, cssVar, em, rem, px, percent, s, ms, deg, vh, vw, join, linearGradient, radialGradient, background, font, margin, padding, cubicBezier, filter, dropShadow, blur, brightness, contrast, hueRotate, invert, opacity, saturate, sepia, text } from "./helpers"
...
export type THelpers = {
    ...
    range: typeof range; rangeMapEntries: typeof rangeMapEntries; transition: typeof transition; transform: typeof transform; boxShadow: typeof boxShadow; convertBoxShadow: typeof convertBoxShadow; border: typeof border
    rgb: typeof rgb; rgba: typeof rgba; important: typeof important; cubicBezier: typeof cubicBezier
    lerpcss: typeof lerpcss; hsl: typeof hsl; lightDark: typeof lightDark; calc: typeof calc; url: typeof url; format: typeof format
    hslFrom: typeof hslFrom; rgbFrom: typeof rgbFrom; cssVar: typeof cssVar
    ...
    join: typeof join; linearGradient: typeof linearGradient; radialGradient: typeof radialGradient; background: typeof background; font: typeof font; fontFamily: typeof font; margin: typeof margin; padding: typeof padding
